...
// fs module allows us to read and write content for responses!!copy
var fs = require('fs');
...
var server = http.createServer(function (request, response){
    ...
    if(request.url === '/') {
    ...
    else if(request.url === '/images/cats/cat1'){
        // notice we won't include the utf8 encoding
    ...
    else if(request.url === '/images/cats/cat2'){
        // notice we won't include the utf8 encoding
      ...
      else if(request.url === '/cars/news') {
        fs.readFile('./views/carnews.html', 'utf8', function (errors, contents){
            response.writeHead(200, {'Content-Type': 'text/html'});
            response.write(contents); 
            response.end();
        });
